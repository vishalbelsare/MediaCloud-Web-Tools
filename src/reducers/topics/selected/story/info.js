...
import { TAG_SET_DATE_GUESS_METHOD, TAG_SET_EXTRACTOR_VERSION, TAG_SET_GEOCODER_VERSION, TAG_SET_NYT_LABELS_VERSION }
  from '../../../../lib/tagUtil';
...
const info = createAsyncReducer({
  ...
  handleSuccess: payload => ({
    ...
    nytThemesVersion: tagWithTagSetsId(payload.story_tags, TAG_SET_NYT_LABELS_VERSION),
  }),
