...
const messages = {
  ...
  wordSpaceLayoutHelp: { id: 'wordSpace.help', defaultMessage: '<p><b>Reading the Word Space</b></p><p>The size and color of a word tells you how often it is used; bigger and darker words are used more often. The distance from the center tells you how many different contexts a word is used in; words used in a wide variety of phrases show up near the middle while words used in only a few phrases are far from the middle. When you hover over a word with your mouse, it changes color to make it easier to read. Words that are used in similar phrases also change color, and are highlighted inside a light cone. This "similarity" is based on an algorithmic analysis of how all the words are used together. Double-click to zoom in to a specific area of the chart; double-click again to zoom out.</p><p><b>Data Source</b></p><p>The layout of words is based on a word2vec machine learning model, which uses neural networks to build a model of how likely a word is to show up in phrases, and how likely phrases are to contain a word. We have integrated the a pretrained word2vec model from the Google News project (<a href="https://code.google.com/archive/p/word2vec/">code</a>, <a href="https://arxiv.org/pdf/1310.4546.pdf">citation</a>). This was built based on the patterns of use in a huge corpus of English language news reporting, and thurs reflects biases and narratives that are commonly seen there.</p>' },
