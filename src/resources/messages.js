...
const messages = {
  ...
  geoHelpTitle: { id: 'geo.help.title', defaultMessage: 'About Our Geo-Parsing' },
  geoHelpContent: { id: 'geo.help.content', defaultMessage: 'We automatically detect the countries and states an article is about using our CLIFF-CLAVIN engine. This finds all the places mentioned in an article and then uses some heuristics we\'ve built and tested to work well on news stories.' },
