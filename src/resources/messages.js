...
const messages = {
  ...
  wordCloudWord2VecLayoutHelp: { id: 'wordcloud.word2VecHelp', defaultMessage: '<p><b>About Word2Vec 2D Layout</b></p><p>The Word2Vec 2D Layout shows you how the most common words are used together. Each word is bigger and dark if it is used more, and it is positioned next to other words it is used with.<p><p>This data is generated by querying the Google News word2vec model. This turns each word into a vector telling us information about other words it is commonly used with in the online news shown by Google News. We take that information and turn it into a 2d representation to show how the words in your query are used together in common news reporting.</p>' },
  ...
  storyCustomDate: { id: 'story.customDate', defaultMessage: 'Custom Data' },
