...
const messages = {
  ...
  wordCloudWord2VecLayoutHelp: { id: 'wordcloud.word2VecHelp', defaultMessage: '<p><b>About the Word2Vec 2D Views</b></p><p>The Word2Vec Map shows you how the most common words are used together. Each word is bigger and darker if it is used more, and it is positioned next to other words it is used with. On the Topic-specific map, words that are used together more often in the topic show up closer together on this map. On the GoogleNews map, words that are used together more often in general news reporting show up closer together on the map. Looking at physical clusters of words can help you identify potential subtopics that capture different takes on your topic. The difference between the two maps can reveal how reporting on this topic is different than more general news reporting</p>' },
