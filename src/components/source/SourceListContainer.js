...
import { fetchSourceCollectionSetList } from '../../actions/sourceActions';
import * as fetchConstants from '../../lib/fetchConstants.js';

const localMessages = {
  sourcesListTitle: { id: 'sources.list.title', defaultMessage: 'Recent Sources' },
};
...
const mapStateToProps = (state) => ({
  fetchStatus: state.sources.all.fetchStatus,
  sources: state.sources.all.list,
});

const mapDispatchToProps = (dispatch) => ({
  fetchData: () => {
    dispatch(fetchSourceCollectionSetList());
  },
});
