  ...
  return (
    <Grid>
      <form className="focus-create-top-countries" name="focusCreateEditTopCountriesForm" onSubmit={handleSubmit(finishStep.bind(this))}>
        ...
        <Row>
          <Col lg={8} md={12}>
            <MediaTypeCoveragePreviewContainer topicId={topicId} numCountries={numCountries} />
          </Col>
        </Row>
        <Row>
          <Col lg={8} md={12}>
            <MediaTypeStoryCountsPreviewContainer topicId={topicId} numCountries={numCountries} />
          </Col>
        </Row>
        <Row>
          <Col lg={8} xs={12}>
