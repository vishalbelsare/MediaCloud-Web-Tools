...
const localMessages = {
  ...
  moreContentDescription: { id: 'marketing.globalCollections.description', defaultMessage: '<p>A topic is seeded with the stories we already have in our database.  Then it follows the links in those stories to find more reporting that matches your queries, so you get a better picture of coverage across the media ecosystem.  This process, called "spidering", is repeated 15 times to create a bigger corpus for reasearching. We also apply more rigorous de-duplication of stories that appeared at muliple URLs.</p>' },
