...
const localMessages = {
  ...
  intro: { id: 'errors.storySwitchover.intro', defaultMessage: '<b>Your current queries and topics will need to be updated after May 12 because they will produce different results. <a href="https://mediacloud.org/news/2018/4/12/switching-to-story-based-searching-on-may-12th" target="_new">Learn More</a>.</b>' },
  details: { id: 'errors.storySwitchover.details', defaultMessage: 'We currently do most analysis and searching at the sentence level. We\'re switching to do everything at the story level on May 12, because that is what most people tell us they want. This will also help us save space and make things faster. This is a big change.' },
  learnMore: { id: 'errors.storySwitchover.learnMore', defaultMessage: 'Learn more.' },
};
