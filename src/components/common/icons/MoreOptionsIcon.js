...
const MoreOptionsIcon = props => (
  <div className="app-icon app-icon-medium app-icon-more-options" style={{ backgroundColor: props.backgroundColor }}>
    <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="10.322px" height="2.203px" viewBox="0 0 10.322 2.203" enableBackground="new 0 0 10.322 2.203" xmlSpace="preserve">
      <g>
        <g>
