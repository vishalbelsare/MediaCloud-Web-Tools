...
export const fetchSourceCollectionList = createAsyncAction(FETCH_SOURCE_COLLECTION_LIST, api.sourceCollectionList);

export const fetchSourceDetails = createAsyncAction(FETCH_SOURCE_DETAILS, api.sourceDetails, id => id);

export const fetchSourceCollectionDetails = createAsyncAction(FETCH_SOURCE_COLLECTION_DETAILS, api.sourceCollectionDetails, id => id);
...
export const fetchSourceCollectionTopWords = createAsyncAction(FETCH_SOURCE_COLLECTION_TOP_WORDS, api.sourceCollectionWordCount, id => id);
