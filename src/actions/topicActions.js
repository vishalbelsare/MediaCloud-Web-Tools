...
export const FETCH_TOPIC_CUSTOM_MAP_FILE = 'FETCH_TOPIC_CUSTOM_MAP_FILE';
...
export const fetchCustomMap = createAsyncAction(FETCH_TOPIC_CUSTOM_MAP_FILE, api.fetchCustomMap);
