...
export const CREATE_THEME_FOCUS_SET = 'CREATE_THEME_FOCUS_SET';
...
export const createThemeFocalSet = createAsyncAction(CREATE_THEME_FOCUS_SET, api.createThemeFocalSet);
